...
with torch.no_grad():
    ...
    print('Total Time',(compute_holograms_time - init_time)/1e9,'seconds')
    print('Total Time (post-wait)',(compute_holograms_time - start_time)/1e9,'seconds')
    ...
    lev.levitate(holograms, num_loops=20)
    print('Done')
    input()
    lev.disconnect()
    print(number)
